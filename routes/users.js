...
import { uploadProfilePicSVC } from "../services/firebase.cjs";

let auth_router = Router();

auth_router.get("/", read);
auth_router.post("/register", uploadProfilePic(), uploadProfilePicSVC, validator(userRegister), accountExists, createHash, register);
